/**
 * Toast Notifications for PDF Generation
 * Provides user feedback for PDF operations
 */
...
/**
 * Pre-configured toast functions for PDF operations
 */
export const pdfToasts = {
  ...
  // Specific PDF operation toasts
  pdfGenerated: (clientName: string, onView?: () => void) => ({
    type: 'success' as const,
    title: 'PDF gerado com sucesso!',
    message: `Proposta para ${clientName} foi criada.`,
    action: onView ? { label: 'Visualizar', onClick: onView } : undefined
  }),

  pdfGenerationFailed: (error: string, onRetry?: () => void) => ({
    type: 'error' as const,
  ...
  pdfSaved: (clientName: string) => ({
    type: 'success' as const,
    title: 'Proposta salva',
    message: `Proposta para ${clientName} foi salva com sucesso.`
  }),

  pdfDeleted: (clientName: string) => ({
    type: 'info' as const,
    title: 'Proposta excluída',
    message: `Proposta para ${clientName} foi removida.`
  })
}
